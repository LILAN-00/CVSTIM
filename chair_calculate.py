...
def print_metrics(hallucination_cap_dict):
    ...
    for k, v in sentence_metrics.items():
        print(f"{k.ljust(10)}: {v * 100:.2f}")


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    
    parser.add_argument("--cap_file", type=str, default='log/llava-1.5/chair/ours/gamma_0.5-beam_1.jsonl',
    ...
    parser.add_argument("--save_path", type=str, default='log/llava-1.5/chair/ours/gamma_0.5-beam_1-cal.jsonl',
